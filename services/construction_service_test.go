...
import (
	...
	mocks "github.com/ElectraProtocol/rosetta-electraprotocol/mocks/services"
...
func TestConstructionService(t *testing.T) {
	...
	cfg := &configuration.Configuration{
		...
		Params:   electraprotocol.TestnetParams,
		Currency: electraprotocol.TestnetCurrency,
	}
	...
	metadata := &constructionMetadata{
		ScriptPubKeys: []*electraprotocol.ScriptPubKey{
			{
	...
	// Test Submit
	electraprotocolTransaction := "" // nolint
	mockClient.On(
		"SendRawTransaction",
		ctx,
		electraprotocolTransaction,
	).Return(
