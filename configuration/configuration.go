...
const (
	...
	// Mainnet is the ElectraProtocol Mainnet.
	Mainnet string = "MAINNET"

	// Testnet is ElectraProtocol Testnet.
	Testnet string = "TESTNET"

	// mainnetConfigPath is the path of the ElectraProtocol
	// configuration file for mainnet.
	mainnetConfigPath = "/app/electraprotocol-mainnet.conf"

	// testnetConfigPath is the path of the ElectraProtocol
	// configuration file for testnet.
	testnetConfigPath = "/app/electraprotocol-testnet.conf"
